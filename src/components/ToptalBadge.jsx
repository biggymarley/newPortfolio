const hex = "[clip-path:polygon(50%_0,100%_24%,100%_76%,50%_100%,0_76%,0_24%)]";

// Official Toptal "Top 3% Talent" badge, converted from Toptal's embed snippet.
const ToptalBadge = ({ hireUrl }) => {
  return (
    <div className={`inline-block bg-[#25a9ef] p-1.5 ${hex} shrink-0`}>
      <div
        className={`w-[200px] pt-6 pb-10 flex flex-col items-center gap-2 text-white text-center bg-[linear-gradient(153deg,#0667ff_18%,#204ecf_40%,#0f256e_80%)] shadow-[0_28px_50px_rgba(6,30,96,0.35)] ${hex}`}
      >
        ...
        <h3 className="m-0 text-[19px] font-bold leading-none font-sans">TOP 3% TALENT</h3>
        <div className="w-[120px] h-px bg-[#25a9ef]"></div>
        <span className="text-base opacity-80 -mb-1.5 font-sans">Vetted by</span>
        ...
        <a
          ...
          className="inline-flex items-center justify-center px-5 py-1 rounded-md bg-[#296bff] text-white text-base font-medium font-sans hover:underline underline-offset-2"
        >
          Hire me
        </a>
      </div>
